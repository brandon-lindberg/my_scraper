...
def main():
    ...
    # 2) For each site, crawl and store results
    for site_info in sites:
        ...
        site_pages_data = crawl_website(site_id, url, max_pages=5)
        all_results.extend(site_pages_data)

    # 3) Write results to a single JSON file (or separate files, your choice)
